...
public class MyClassLoader extends ClassLoader{
    ...
    @Override protected Class<?> findClass(String name) throws ClassNotFoundException
    {
        try {
            ...
            //需要加载的.class字节码的位置
            String classPath="E:\\WorkspaceIdea\\Practice\\become-clever\\2022-interview-questions\\src\\main\\resources\\classFile\\ClassTest.class";
    ...
    //相应的字节码解密类，在加载E盘根目录下的被加密过的ClassTest.class字节码的时候，进行相应 的解密。
