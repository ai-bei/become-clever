...
/**
 * 重写第三方依赖包的代码，禁止扫描数据库表结构，加快启动速度<br>
...
//	}
	...
	private static List<String> loadAllTableNames(final Connection connection, final String databaseType)
			throws SQLException {
...
//			final List<String> tableNames, final List<List<String>> tableGroups, final String databaseType)
//			throws SQLException {
